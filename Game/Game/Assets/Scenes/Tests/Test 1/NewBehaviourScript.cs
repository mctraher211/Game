...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            speedX = -horizontalSpeed;//Будет хранить отрицатильное значение скорости что поможет двигаться по оси X влево.
            health = 10;
        }
        ...
        else if (Input.GetKeyDown(KeyCode.Space))//Если была нажата клавиша Space. 
        {
        ...
        speedX = 0;//Метод который обнуляет скорость если клавиши не нажаты. 
    }
